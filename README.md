...
8. **Entity Tracking Hysteresis** (`EntityTrackingHysteresisEnabled`)
...
9. **Distance-Based Send Frequency** (`DistanceBasedSendFrequencyEnabled`)
...
10. **Attribute Sync Delta Updates** (`AttributeSyncResyncPreventionEnabled`)
...
11. **Entity Spawn Priority Ordering** (`EntitySpawnPriorityOrderingEnabled`)
