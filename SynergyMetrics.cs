...
namespace Synergy
{
    ...
    public static class SynergyMetrics
    {
        ...
        private static long lastSaveSuspendMs;
        private static long lastSaveWriteMs;
        ...
        public static void Initialize(ICoreServerAPI api)
        {
            ...
            meter.CreateObservableGauge("synergy.save.suspend_ms", () => Volatile.Read(ref lastSaveSuspendMs));
            meter.CreateObservableGauge("synergy.save.write_ms", () => Volatile.Read(ref lastSaveWriteMs));
        ...
        public static void RecordSaveSuspendTime(long ms)
        {
            Volatile.Write(ref lastSaveSuspendMs, ms);
        }

        public static void RecordSaveWriteTime(long ms)
        {
            Volatile.Write(ref lastSaveWriteMs, ms);
        }
        ...
        public static string GetStatsText()
        {
            ...
            long suspMs = Volatile.Read(ref lastSaveSuspendMs);
            long writeMs = Volatile.Read(ref lastSaveWriteMs);
            ...
            return $"=== Synergy Stats ===\n" +
                   ...
                   $"Last save: {suspMs}ms suspend + {writeMs}ms write\n" +
        ...
        private static void LogPeriodic(float dt)
        {
            ...
            sapi?.Logger.Notification(
                "[Synergy] Stats: {0} active, {1} sleeping, {2}% AI throttled, {3} delta clients, save {4}ms",
                active, sleeping, aiPct, dClients, suspMs);
        }
    }
}
