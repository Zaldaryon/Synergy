...
{
    /// <summary>
    /// Skip collision resolution for stationary entities with no environmental flags.
    ...
    public static class CollisionFastPath
    {
        ...
        public static void Initialize(ICoreServerAPI api, Harmony harmony)
        {
            ...
            {
                api.Logger.Warning("[Synergy] CollisionFastPath: Could not find ApplyTerrainCollision, skipping");
                return;
            }
            ...
            api.Logger.Notification("[Synergy] CollisionFastPath: Entity collision fast-path active");
        }
